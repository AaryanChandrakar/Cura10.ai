"""
Cura10.ai — PDF Report Generator
...
def _header_section(styles, patient_name: str, specialists: list[str], created_at: str):
    ...
    elements.append(Paragraph("CURA10.AI", styles["BrandTitle"]))
...
async def generate_diagnosis_pdf(
    ...
    doc = SimpleDocTemplate(
        ...
        leftMargin=18 * mm,
        rightMargin=18 * mm,
        title=f"Cura10.ai - Diagnosis Report - {patient_name}",
        author="Cura10.ai",
    ...
    elements.append(Paragraph(
        ...
        "Cura10.ai and its creators bear no responsibility for any actions taken based on this report.",
        styles["Disclaimer"],
    ))
    ...
    elements.append(Spacer(1, 4 * mm))
    elements.append(Paragraph(
        f"Generated by Cura10.ai v2.0 | {datetime.now(timezone.utc).strftime('%Y-%m-%d %H:%M UTC')}",
        styles["PageFooter"],
    ))
